...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setTextColor(mContext.getResources().getColor(R.color.primary_color));
        try {
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setTextColor(mContext.getResources().getColor(R.color.sub_title_color));
...
//            button.setBackgroundResource(R.drawable.material_card);
            button.setTextColor(mContext.getResources().getColor(R.color.primary_color));
            button.setText(text);
