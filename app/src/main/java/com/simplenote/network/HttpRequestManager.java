...
package com.simplenote.network;
...
public class HttpRequestManager implements IRequest {
    ...
    public void init(Context context) {
        ...
        File strCacheDir = new File(MyClient.getMyClient().getStorageManager().getRootDirPath());
...
//        String tagertUrl = ApiParamUtil.wrappeUrlParam(url, param);
    ...
    public void sendImageForPostWithJson(final String url, final Map<String, String> param,List<File> fileList, final IRequestCallback callback){
        this.doAddQueue(this.uploadImageForPostWithJson(url, param,fileList, callback));
    }
...
//        final Map wrappMap = ApiParamUtil.wrappeBaseParam(param);
        ...
        StringRequestJsonResult request = new StringRequestJsonResult(Request.Method.POST,url, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject response) {
...
//                    StatManager.statEventNum(HttpRequestManager.this.mContext, "http_fail", map);
    ...
    private Request uploadImageForPostWithJson(final String url, final Map<String, String> param,List<File> fileList, final IRequestCallback callback){

//        String fileName = "files";
//
//
//        MultipartRequest request = new MultipartRequest(url,fileName,fileList,param, new Response.Listener<JSONObject>() {
//            public void onResponse(JSONObject response) {
//
//                if (callback != null) {
//                    callback.onResponseSuccess(response);
